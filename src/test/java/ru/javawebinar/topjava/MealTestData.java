...
public class MealTestData {
    ...
    public static final int MEAL_NOT_FOUND = 5;
    ...
    public static final Meal adminMeal = new Meal(START_SEQ + 9, LocalDateTime.of(2015, Month.JUNE, 1, 14, 0), "Админ ланч", 510);

    public static Meal getNew() {
        return new Meal(null, LocalDateTime.of(2021, Month.JUNE, 21, 9, 5), "New meal", 1000);
    }
